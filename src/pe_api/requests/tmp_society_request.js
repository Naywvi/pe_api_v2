...
module.exports = {
  ...
  update: async (user_request) => {
    try {
      ...
      if (modifications.length === 0) throw error_message.no_modifications;
      ...
      if (tmp_society.modifiedCount === 0) throw error_message.update_failed;
  ...
  delete: async (user_request) => {
    try {
      ...
      if (!tmp_society) throw error_message.not_found;
      if (tmp_society.modifiedCount === 0) throw error_message.not_found;
